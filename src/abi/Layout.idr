...
|||
||| KEY CONCEPTS:
||| 1. **Alignment**: Ensuring fields start at addresses divisible by their type size.
||| 2. **Padding**: Calculating the 'gap' bytes required between struct fields.
||| 3. **Total Size**: Verifying the final byte width of the packed structure.
